...
export function CustomersPage() {
  ...
  const [data, setData] = useState([{ id: 0, name: 'Bhanu', email: 'bhanu@example.com', phone: '+91 98765 43210', walletBalance: 780.00, pendingOrders: 1 },
  ...
  return (
    <div className="customers-page">
      ...
      <div className="customers-page__table">
        <CustomerTable customers={data} searchFilter={searchFilter} />
      </div>
    </div>
  );
}
